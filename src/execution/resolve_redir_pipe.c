...
/*   Updated: 2026/03/26 17:34:49 by fgargot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	resolve_pipe_redirs(t_node *node, t_list **envs, t_ctx *ctx, int *fd)
{
	...
	redir_invalid_left = resolve_redirs(node->left, NULL, *envs, ctx);
	...
	redir_invalid_right = resolve_redirs(node->right, NULL, *envs, ctx);
